...
import static deitelChapters.chapter8.ticTacToe.TicTacCharacters.O;

public class TicTacToeSinglePlayerGame {
    ...
    public static void setWinningPositions(String[][] moves) {
        if (moves[0][0].equals(X.getSymbol()) &&
            ...
            System.out.printf("%n%13s win!!!", players[TicTacToePlayer.getCurrentPlayer()].getName());
            isWon = true;
        ...
        if (moves[0][2].equals(O.getSymbol()) &&
                moves[1][1].equals(O.getSymbol()) &&
                (moves[2][0].equals(O.getSymbol()))) {
            System.out.printf("%n%13s wins!!!", players[TicTacToePlayer.getCurrentPlayer()].getName());
            isWon = true;
        } else if (moves[0][0].equals(O.getSymbol()) &&
                moves[1][1].equals(O.getSymbol()) &&
                (moves[2][2].equals(O.getSymbol()))) {
